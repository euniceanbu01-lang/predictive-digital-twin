...
def _calculate_leak(flow_lps, pressure_bar):
    ...
    # ✅ Correct leak magnitude (handles both ↑ and ↓)
    leak_lps = abs(flow_lps - EXPECTED_FLOW)
...
def predict_leak(pressure_bar, flow_lps):
    ...
    return {
        ...
        "Leak_Magnitude_LPM": round(lps * 60, 2),  # 🔥 Step 6 applied here
